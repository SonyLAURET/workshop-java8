...
public class Stream_02_Test {
    ...
    public void test_map() throws Exception {
        ...
        List<Customer> result = orders.stream().map(t->t.getCustomer()).distinct().collect(Collectors.toList());
    ...
    public void test_flatmap() throws Exception {
        ...
        IntSummaryStatistics result = orders.stream().flatMap(x-> x.getPizzas()
        									.stream()).collect(Collectors.summarizingInt(y-> y.getPrice()));
